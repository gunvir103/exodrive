...
// Car Review Type for SEO aggregate rating support
...
export type AppCar = CarBase & {
    ...
    reviews?: CarReview[]; // Optional reviews for aggregate rating in SEO schema
};
    ...
    getCarById: async (supabase: SupabaseClient, id: string): Promise<AppCar | null> => {
        try {
            ...
            const { data: carData, error: carError } = await supabase
                ...
                .select(`
                    *,
                    ...
                    reviews:car_reviews!car_reviews_car_id_fkey(rating, comment, name, date, is_approved, is_verified)
                `)
                .eq("id", id)
            ...
            const assembledCar: AppCar = {
                ...
                reviews: typedCarData.reviews || undefined, // Only include if present
