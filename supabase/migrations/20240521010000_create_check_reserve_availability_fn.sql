    ...
    FOR loop_date IN SELECT generate_series(p_start_date, p_end_date, '1 day'::interval)::date LOOP
        ...
        IF FOUND THEN
            ...
            ELSE
                ...
                -- Update it to 'pending' and link to this booking_id
                UPDATE public.car_availability
                SET status = 'pending', booking_id = p_booking_id, updated_at = now()
        ...
        ELSE
            ...
            VALUES (p_car_id, loop_date, 'pending', p_booking_id);
        END IF;
    END LOOP;
